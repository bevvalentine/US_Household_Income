CREATE TABLE "mytable" (
  "# US Household Income Exploratory Data Analysis" text NULL
);

INSERT INTO "mytable" ("# US Household Income Exploratory Data Analysis")
VALUES
('SELECT *'),
...
('ON u.id = us.id;'),
('# In this data we do not want to include the Mean'),
('SELECT *'),
('FROM us_project.us_household_income u'),
('INNER JOIN us_project.us_household_statistics us'),
('ON u.id = us.id'),
('WHERE Mean <> 0;'),
('# Look at the Mean and the Median of the State Name'),
('SELECT u.State_Name'),
('FROM us_project.us_household_income u'),
('INNER JOIN us_project.us_household_statistics us'),
('ON u.id = us.id'),
